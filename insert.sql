...
--
-- Host: localhost
-- Generation Time: Mar 29, 2022 at 11:51 PM
...
INSERT INTO `Enrolment` (`EID`, `StudentID`, `MoudleID`, `Score`, `Semester`, `Year`) VALUES
(1, 1, 1, 85, 'S1', 2020),
(2, 2, 2, 76, 'S2', 2020),
(3, 3, 3, 88, 'S1', 2020),
(4, 4, 1, 90, 'S1', 2019),
...
--
-- Dumping data for table `Moudle`
--

INSERT INTO `Moudle` (`MoudleID`, `MoudleName`, `DeptID`, `Programme`, `TMode`, `Date_of_Firstoffer`) VALUES
...
INSERT INTO `Teach` (`TID`, `MoudleID`, `StaffID`, `SpaID`, `Semester`, `Year`) VALUES
(1, 4, 5, 1, 'S1', 2019),
(2, 2, 4, 2, 'S1', 2018),
(3, 3, 10, 3, 'S2', 2020),
(4, 4, 7, 4, 'S1', 2017),
